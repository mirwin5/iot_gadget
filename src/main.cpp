...
AdafruitIO_Feed *temperature = io.feed("sewer-monitor.temperature");
AdafruitIO_Feed *humidity = io.feed("sewer-monitor.humidity");
AdafruitIO_Feed *barpressure = io.feed("sewer-monitor.barpressure");
AdafruitIO_Feed *altitude = io.feed("sewer-monitor.altitude");
AdafruitIO_Feed *led_controller = io.feed("sewer-monitor.led");
...
void setup()
{
  ...
  // Setup the clock
  waitForSync();
  chicagoTZ.setLocation("America/Chicago");
